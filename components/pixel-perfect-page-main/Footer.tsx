...
export default function PixelPerfectFooter() {
  ...
  return (
    <footer className="border-t border-border">
      <div
        className="w-full border-b-[0.5px] border-border"
        style={{ backgroundColor: "var(--grey-v1)" }}
      >
        <div className="max-w-[94rem] mx-auto padding-global py-6 flex flex-col lg:flex-row justify-between lg:items-center gap-6">
          <h3 className="text-lg font-semibold text-foreground max-w-2xl">
            Recibi alertas y oportunidades de ahorro en tus productos favoritos
          </h3>
          <div className="flex items-end gap-3 flex-wrap">
            <div>
              ...
              <input
                type="email"
                className="mt-1 block h-11 w-full min-w-[16rem] sm:min-w-[20rem] border border-border rounded-sm px-3 text-sm bg-background text-foreground outline-none focus:ring-1 focus:ring-ring"
              />
            </div>
            <Button variant="hero">
              Unirme
      ...
      <div className="max-w-[94rem] mx-auto padding-global py-12 lg:py-14">
        <div className="p-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-10 lg:gap-8">
            <div className="lg:col-span-2 flex flex-col gap-6 lg:pr-10 lg:border-r-[0.5px] lg:border-border">
              <Link
              ...
              <div className="flex items-center gap-3">
                <a
                  href="#"
                  className="w-9 h-9 border border-border rounded-sm flex items-center justify-center text-muted-foreground hover:text-foreground transition-colors"
                >
      ...
      <div className="relative border-t border-border">
        ...
        <div className="relative max-w-[94rem] mx-auto padding-global py-10">
