		...
		<div className='mt-20'>
			{productData[0] ? (
				<div className='flex gap-10  sm:cap-5 xl:flex-row flex-col'>
					<div className='flex flex-row m-8 h-[max-content]'>
						...
						<div className='product-info'>
							<div className='flex flex-col gap-2'>
								...
								<p className='text-[21px] text-black opacity-50 line-through dark:text-white'>
									{productData[0].currentPrice !== productData[0].originalPrice
							...
							<p className='text-sm md:text-base lg:text-sm w-[70%] m-2'>
								{productData[0].refurbishedMessage}
							</p>
