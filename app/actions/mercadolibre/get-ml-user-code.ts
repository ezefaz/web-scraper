...
const BACKEND_URL =
	"https://c85b-2800-40-3c-a31-38b4-98b0-216c-5b1d.ngrok-free.app/profile/business";

const REDIRECT_URL =
	"https://auth.mercadolibre.com.ar/authorization?response_type=code&client_id=7423381817150989&redirect_uri=https://c85b-2800-40-3c-a31-38b4-98b0-216c-5b1d.ngrok-free.app/profile/business";
...
export async function getMLUserCode(code: string | null) {
	...
	try {
		...
		let refreshToken = (await responseToken).data.refresh_token;
